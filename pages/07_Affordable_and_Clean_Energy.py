...
st.title('Зорилт 7. Сэргээгдэх эрчим хүчийг нэвтрүүлэх')

st.write('Хүн бүрийг боломжийн, найдвартай, тогтвортой, орчин үеийн эрчим хүч хэрэглэх боломжоор хангах')
